...
final_width = 680
final_height = 249
input_dir = 'Input_Images/Calib_Images/'
output_dir = 'Detected_Images/Calib_Images/'
for i in range(1, 11):
    filename_read = input_dir + '%scm.jpg' % (i - 1)
    filename_write = output_dir + '%scm.jpg' %(i - 1)


    # filename_read = input_dir + 'nolaser.jpg'
    # filename_write = output_dir + 'nolaser.jpg'
