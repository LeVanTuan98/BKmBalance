...
for i in range(1, 4):
    filename_read = 'images/image_White-Blue/%s.jpg' %(i)
    filename_write = 'Detected Images/image_White-Blue/%s.jpg' %(i)
...
# STEP 2: Detect WHITE frame and the coordinate of laser pointer
    white_frame, cX, cY = detect_white_frame_laser_poiter(original_image)
