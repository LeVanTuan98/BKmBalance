...
ap.add_argument("-p", "--pvideo",
                help="path to the (optional) video file")  # mở video file có sẵn
args = vars(ap.parse_args())

#Video Capture
cap = cv2.VideoCapture(args["pvideo"])

# create Trackbars
cv2.namedWindow("Trackbars")
cv2.createTrackbar("H_min", "Trackbars", 100, 179, nothing)
cv2.createTrackbar("S_min", "Trackbars", 50, 255, nothing)
cv2.createTrackbar("V_min", "Trackbars", 50, 255, nothing)
cv2.createTrackbar("H_max", "Trackbars", 120, 179, nothing)
